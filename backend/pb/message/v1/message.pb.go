...
type Message struct {
	...
	Content     string                 `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty"`              // Messsage content
...
type CreateMessageRequest struct {
	...
	Content   string   `protobuf:"bytes,3,opt,name=content,proto3" json:"content,omitempty"`              // Messsage content
...
type Mention struct {
	...
	MemberRoles []string `protobuf:"bytes,3,rep,name=member_roles,json=memberRoles,proto3" json:"member_roles,omitempty"`      // mention MenberRole
